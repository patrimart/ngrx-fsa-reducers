 ...
 */
export const caseFn = <S, P>(
    actionCreator: ActionCreator<P>,
    handler: Handler<S, P>,
): Reducer<S, P> => (s: S, a: Action<P>) =>
 ...
 */
export const reducerDefaultFn: ReducerDefaultFn = <S>(
    ...cases: Array<Reducer<S, any>>,
) => (initialState: S): Reducer<S, any> => (s = initialState, a: any) =>
    (reducerFn as any)(...cases)(s, a);
...
export const reducerFn: ReducerFn = <S>(
    ...cases: Array<Reducer<S, any>>,
): Reducer<S, any> => (state: S, action: any) =>
    cases.reduceRight(
